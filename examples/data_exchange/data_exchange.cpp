...
class data_exchange : public simex::rx_remote_block {
 public:
  explicit data_exchange(SimStruct *s) : rx_remote_block(s) {
    ...
    dummy_param = register_string_parameter("dummy");
    double_param = register_scalar_parameter<double>("double", true);
  ...
  std::shared_ptr<simex::rx_string_param> dummy_param;
  std::shared_ptr<simex::rx_scalar_param<double>> double_param;
};
